...
import com.github.jdsjlzx.recyclerview.LHRecyclerView;
import com.github.jdsjlzx.recyclerview.LRecyclerViewAdapter;
import com.github.jdsjlzx.recyclerview.ProgressStyle;
import com.lzx.demo.R;
import com.lzx.demo.adapter.HorizontalDataAdapter;
...
public class HorizontalLinearLayoutActivity extends AppCompatActivity{
    ...
    private LHRecyclerView mRecyclerView = null;

    private HorizontalDataAdapter mDataAdapter = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView = (LHRecyclerView) findViewById(R.id.list);

        mDataAdapter = new HorizontalDataAdapter(this);
        ...
        //add a HeaderView
        final View header = LayoutInflater.from(this).inflate(R.layout.sample_horizontal_header,(ViewGroup)findViewById(android.R.id.content), false);
        ...
        mRecyclerView.setLScrollListener(new LHRecyclerView.LScrollListener() {
    ...
    private class PreviewHandler extends Handler {
        ...
        private WeakReference<HorizontalLinearLayoutActivity> ref;

        PreviewHandler(HorizontalLinearLayoutActivity activity) {
            ref = new WeakReference<>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            final HorizontalLinearLayoutActivity activity = ref.get();
